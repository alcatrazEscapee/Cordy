...
pub enum RuntimeError {
    ...
    ValueErrorValueWouldBeTooLarge,
    ValueErrorVariableNotDeclaredYet(String),
    ValueErrorValueMustBeNonNegative(ValuePtr),
    ValueErrorArgMustBeNonNegativeInt(NativeFunction),
    ValueErrorBinaryOpMustNotBeNegative(ValuePtr, BinaryOp, i64),
    ValueErrorPowerByNegative(i64),
    ValueErrorValueMustBePositive(i64),
    ValueErrorDivideByZero,
    ValueErrorModuloByZero,
    ValueErrorArgMustBeNonEmpty(NativeFunction),
    ValueErrorCannotConvertStringToIntBadParse(ValuePtr, String),
    ValueErrorCannotConvertStringToRationalBadParse(ValuePtr, String),
    ValueErrorCannotConvertRationalToIntTooLarge(ValuePtr),
    ValueErrorCannotConvertRationalToIntNotAnInteger(ValuePtr),
    ...
    TypeErrorArgMustBeRational(ValuePtr),

...
impl AsError for ParserError {
    fn as_error(&self) -> String {
        ...
        match &self.error {
            ...
            ExpectedCommaOrEndOfComma(e) => format!("Expected a ',' or ')' after parenthesis, got {} instead", e.as_error()),
            ...
            UndeclaredSelf => String::from("Unresolved reference to a 'self' outside of an instance method"),
            ...
            AssignmentTargetNotAssignable => String::from("The left hand side is not assignable"),
            ...
            LValueEmptyUsedOutsideAssignment => String::from("Expected an expression, got '_' instead"),
            LValueVarEmptyUsedOutsideAssignment => String::from("Expected an expression, got '*_' instead"),
